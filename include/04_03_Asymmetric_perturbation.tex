...
This includes the approximation of a radial flux of electrons being equivalent to the parallel flux along the magnetic field lines, as represented by \cref{eq:heat_flux_approximation}.
...
The boundary conditions for the asymmetric NGS model quantities are derived from the general NGS boundary conditions in \cref{eq:full_boundary_conditions} by assuming the perturbation to be small, which yields 
\begin{gather}
\begin{gathered}
    q_1(r_p) = 0, \quad
    T_1(r_p) = 0, \quad
