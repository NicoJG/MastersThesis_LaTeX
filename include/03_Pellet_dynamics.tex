...
The main idea is that the frozen material of the pellet is continuously ablated while traversing the fusion plasma, thereby depositing fuel or impurities in the plasma.
...
Once the flow velocity reaches the speed of sound in the gas, the expansion becomes the driving factor for further acceleration to supersonic speeds.
