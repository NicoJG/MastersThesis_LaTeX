...
In the NGS model, this path is replaced by a \enquote{ficticious} radial path according to geometric reasoning that the line integrated density is equivalent.
...
However, this factor enters our expression for the pellet rocket force in a power of 2/3 (through $\mu$ in \cref{eq:prefactor_p_star}) and could thus affect our predictions significantly.
...
This emphasises the importance of developing accurate models for the pellet rocket effect.
...
%However, since the mono-energetic beam approximation works well for the isotropic NGS model, we recommend focussing on the latter approximation.
