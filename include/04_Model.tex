...
\end{equation}
The fact that this quantity is independent of the radius means that the total outflow of particles through any spherical shell is $G$, which is the particle ablation rate.
Note that \textcite{parks_effect_1978} defined $G$ to be the mass ablation rate $G_\text{NGS} = m \cdot G$.
...
\begin{gather}
    \rho v \pdv{\rho}{r} = - \pdv{p}{r} \quad \quad \text{and} \\
    \frac{G}{4 \pi r^2} \pdv{r}(\frac{m}{2}v^2 + \frac{\gamma}{\gamma - 1} T) = \mu \pdv{q}{r}
\end{gather}
respectively. 
...
(Describe how normalization is useful to reduce the amount of needed numerical solutions)
