...
\title{The pellet rocket effect in magnetic confinement fusion}
\subtitle{}
...
\includegraphics[width=0.6\linewidth]{figure/DALL-E_Illustration.png}\\
(\underline{Will not be in the final thesis!} I just played around with DALL-E 3)
\end{figure}
...
Cover: Wind visualization constructed in Matlab showing a surface of constant wind speed along with streamlines of the flow. \vspace{0.5cm}
