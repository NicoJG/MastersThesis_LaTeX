...
\usepackage{parskip}[skip=0pt, parfill]							% Enables vertical spaces correctly 
...
\usepackage[labelfont=bf, textfont=small,
            width=0.9\textwidth, % make the figure captions slightly smaller
