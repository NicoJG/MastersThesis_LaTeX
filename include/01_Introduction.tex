...
Once the material of the pellet is ionized, it begins to spread around the fusion plasma.
...
Momentum conservation dictates that the momentum (mass times velocity) carried by this material must be compensated by an equal but opposite momentum gain by the rocket.
...
The scope of the thesis limits our attention to the case of hydrogenic pellets.
...
The results are then compared to recent 3D Lagrangian particle simulation studies on the same pellet acceleration effect by \textcite{samulyak_simulation_2023} in \cref{sec:results}.
